 ...
 *
 * @author    Marcus Bointon (Synchro/coolbru) <phpmailer1@synchromedia.co.uk>
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        if ('en' !== $langcode) {
            ...
            foreach ($langcodes as $code) {
                $lang_file = $lang_path . 'phpmailer1.lang-' . $code . '.php';
        ...
        if (array_key_exists(2, $images)) {
            ...
            foreach ($images[2] as $imgindex => $url) {
                ...
                if (preg_match('#^data:(image/(?:jpe?g|gif|png));?(base64)?,(.+)#', $url, $match)) {
                    ...
                    $cid = substr(hash('sha256', $data), 0, 32) . '@phpmailer1.0'; //RFC2392 S 2
                ...
                if (
                    ...
                    //RFC2392 S 2
                    $cid = substr(hash('sha256', $url), 0, 32) . '@phpmailer1.0';
                    if (strlen($basedir) > 1 && '/' !== substr($basedir, -1)) {
                        $basedir .= '/';
                    }
